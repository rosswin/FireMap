    ...
    for rstr in sortList:
        for bnd in bandsList:
            ...
            if anchorArray.shape != bandArray.shape:
                print 'arrays still dont match. tell ross to fix the janky array size comparisson code block.'
            else:
                writeGeotiff(outName, bandArray, gt, proj)
